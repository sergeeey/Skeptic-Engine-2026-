...
class MatterSimRealBackend(ISimulationBackend):
    ...
    def _fallback_structure(self, candidate: MaterialCandidate) -> Any:
        ...
        return Atoms(
            "Fe2", positions=[[0, 0, 0], [0.5, 0.5, 0.5]], cell=[2.87, 2.87, 2.87], pbc=True
        )
        ...
        try:
            ...
            with MPRester(mp_key) as mpr:
                ...
                if doc:
                    ...
                    atoms = Atoms(
                        symbols=symbols, scaled_positions=positions, cell=lattice, pbc=True
                    )
                    return atoms
